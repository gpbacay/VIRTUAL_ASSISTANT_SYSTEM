...
__all__ = [
    ...
    'ISpeechPhraseInfo', 'DISPID_SPERequiredConfidence',
    'SPAUDIOOPTIONS', 'eWORDTYPE_DELETED', 'SPSHORTCUTTYPE',
    'SAFTCCITT_uLaw_8kHzMono', 'SDA_Two_Trailing_Spaces',
    'DISPID_SPRsCount', 'SAFT48kHz8BitStereo', 'DISPID_SLPPhoneIds',
    'SPEI_RECO_STATE_CHANGE', 'SpeechEngineProperties',
    'DISPID_SVRate', 'ISpVoice', 'eLEXTYPE_PRIVATE3', 'SPLO_DYNAMIC',
    'SAFT48kHz8BitMono', 'UINT_PTR', 'eLEXTYPE_PRIVATE6',
    'SpNotifyTranslator', 'SRTAutopause', 'SpMMAudioIn',
    'SAFT8kHz16BitMono', 'eLEXTYPE_PRIVATE18', 'ISpeechPhraseElement',
    'DISPID_SVSLastResult', 'SDTAll', 'DISPID_SRCreateRecoContext',
    'DISPID_SRRTTickCount', 'SPPHRASE', 'ISpRecognizer',
    'SpeechWordPronounceable', 'SRAImport', 'DISPID_SLPSymbolic',
    'DISPID_SPIAudioSizeTime', 'SAFT48kHz16BitMono',
    'DISPID_SRGCommit', 'SPINTERFERENCE_TOOFAST',
    'DISPIDSPTSI_ActiveOffset', 'ISpeechMemoryStream',
    'DISPID_SFSClose', 'DISPID_SGRSRule', 'SPDKL_LocalMachine',
    'eLEXTYPE_PRIVATE19', 'DISPID_SOTGetAttribute', 'SDTProperty',
    'SPAR_Low', 'SpeechRecognitionType', 'DISPID_SOTCEnumerateTokens',
    'ISpRecoGrammar2', 'ISpNotifySource', 'ISpeechAudioBufferInfo',
    'DISPID_SAEventHandle', 'SRESoundEnd', 'SpeechBookmarkOptions',
    ...
    'DISPID_SOTDisplayUI', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SPISaveToMemory', 'SpStreamFormatConverter',
    'SPRST_ACTIVE_ALWAYS', 'STCRemoteServer', 'SPPS_RESERVED1',
    'SPSHT_OTHER', 'SDA_One_Trailing_Space', 'DISPID_SPEDisplayText',
    'ISpeechXMLRecoResult', 'SPEI_RESERVED6',
    'DISPID_SpeechVoiceStatus', 'SRERequestUI',
    'SPINTERFERENCE_NOSIGNAL', 'SpeechRuleState',
    'SPTEXTSELECTIONINFO', 'ISpeechGrammarRules', 'SVP_1',
    'SDTPronunciation', 'DISPID_SRCState', 'DISPID_SGRSTs_NewEnum',
    'SLTApp', 'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SDKGetBinaryValue', 'IInternetSecurityMgrSite',
    'SPEI_UNDEFINED', 'SPAS_STOP', 'SVP_6', 'SP_VISEME_0',
    'SPPS_Noun', 'eLEXTYPE_PRIVATE8',
    'SpeechRegistryLocalMachineRoot', 'SP_VISEME_9',
    'eLEXTYPE_PRIVATE11', 'SPDKL_DefaultLocation', 'SRSActiveAlways',
    'SPEI_SR_AUDIO_LEVEL', 'SP_VISEME_2', 'eLEXTYPE_PRIVATE13',
    'DISPID_SVEPhoneme', 'SpStream', 'SAFT22kHz16BitMono',
    ...
    'DISPID_SpeechAudioFormat', 'SAFTGSM610_22kHzMono', 'SVP_21',
    'SAFTCCITT_uLaw_22kHzStereo', 'SPAO_NONE',
    'SWPUnknownWordUnpronounceable', 'DISPID_SLPLangId',
    'SPGRAMMARSTATE', 'SPBO_PAUSE', 'DISPID_SRDisplayUI',
    'ISpRecoContext2', 'DISPID_SVEVoiceChange', 'DISPID_SLGetWords',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SPAPhraseInfo',
    'SREPhraseStart', 'SpeechSpecialTransitionType', 'SPSMF_UPS',
    'SpeechVoiceEvents', 'SPGRAMMARWORDTYPE', 'SpInProcRecoContext',
    'DISPID_SPRuleFirstElement', 'DISPID_SDKEnumValues',
    'ISpNotifySink', 'DISPID_SOTCreateInstance', 'SITooFast',
    'SVESentenceBoundary', 'DISPID_SVAudioOutputStream',
    'DISPID_SPPNumberOfElements', 'SpCompressedLexicon',
    'DISPID_SpeechPhraseReplacements', 'SPLOADOPTIONS',
    'DISPID_SRRAudioFormat', 'STSF_FlagCreate', 'SPPS_Verb',
    'SVSFlagsAsync', 'DISPID_SPRulesItem', 'SREPrivate',
    'DISPID_SRSetPropertyString', 'DISPID_SVPriority',
    'SPSSuppressWord', 'SPBO_TIME_UNITS', 'SPSERIALIZEDPHRASE',
    'DISPID_SRCResume', 'DISPID_SPEAudioTimeOffset', 'SINoise',
    'DISPID_SPIAudioSizeBytes', 'SAFTADPCM_44kHzStereo', 'ISpPhrase',
    'SPAO_RETAIN_AUDIO', 'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SGRSTPropertyName', 'SPPS_RESERVED2',
    'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SVAlertBoundary', 'DISPID_SVSPhonemeId',
    'SRADefaultToActive', 'SpeechVoiceSkipTypeSentence',
    'DISPID_SCSBaseStream', 'DISPID_SVSpeakStream',
    'SPPHRASEPROPERTY', 'DISPID_SPRDisplayAttributes',
    'DISPID_SRIsUISupported', 'DISPID_SVESentenceBoundary',
    'SPVPRIORITY', 'SPPS_RESERVED3', 'SPWORDLIST',
    'ISpeechPhoneConverter', 'SASPause', 'ISpeechVoiceStatus',
    'DISPID_SRRGetXMLResult', 'SRSInactiveWithPurge',
    'DISPID_SVSInputSentencePosition', 'SPAS_RUN', 'SRAExport',
    'DISPID_SVSyncronousSpeakTimeout',
    'DISPID_SVSInputSentenceLength', 'DISPID_SRStatus',
    'SAFTCCITT_uLaw_8kHzStereo', 'SPEI_RESERVED1',
    'DISPID_SRSClsidEngine', 'DISPID_SRRSaveToMemory', 'SVEPrivate',
    'SpeechCategoryVoices', 'SAFTText', 'DISPID_SRCEBookmark',
    'DISPID_SMSGetData', 'eLEXTYPE_PRIVATE10', 'SREAllEvents',
    '_RemotableHandle', 'DISPID_SPRFirstElement',
    'DISPID_SOTCDefault', 'SGRSTTTextBuffer', 'eLEXTYPE_PRIVATE4',
    'DISPID_SRGetRecognizers', 'SPEI_END_INPUT_STREAM',
    'SPEI_PHONEME', 'SVF_None', 'SpeechGrammarTagDictation',
    'tagSPPROPERTYINFO', 'DISPID_SpeechObjectTokenCategory',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SGRSTransitions',
    'DISPID_SRGReset', 'SpSharedRecoContext',
    'DISPID_SPEAudioStreamOffset',
    'DISPID_SPANumberOfElementsInResult',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SPCPhoneToId',
    'SpeechLexiconType', 'ISpEventSink', 'SRSActive',
    'SpeechCategoryPhoneConverters', 'SAFT16kHz8BitMono',
    'ISpPhoneticAlphabetSelection', 'DISPID_SRAudioInputStream',
    'SVPOver', 'DISPID_SLPsItem', 'SPCT_SUB_DICTATION', 'SRAONone',
    'ISpObjectTokenCategory', 'DISPID_SPRuleEngineConfidence',
    'SPAUDIOBUFFERINFO', 'SPFILEMODE', 'DISPID_SABIEventBias',
    'DISPID_SVGetVoices', 'DISPID_SLAddPronunciation', 'SPWT_DISPLAY',
    'SPXRO_SML', 'SpMMAudioOut', 'DISPID_SAVolume',
    'eLEXTYPE_PRIVATE16', 'DISPID_SPARecoResult',
    'SpeechCategoryAudioOut', 'DISPID_SOTMatchesAttributes',
    'SPSERIALIZEDRESULT', 'SAFT44kHz8BitMono',
    'DISPID_SpeechLexiconWord', 'LONG_PTR', 'SP_VISEME_16',
    'SGRSTTEpsilon', 'SPDKL_CurrentConfig', 'DISPID_SVSkip',
    'ISpSerializeState', 'DISPID_SpeechXMLRecoResult',
    'SpeechGrammarState', 'SVP_13', 'SRTSMLTimeout',
    'SPEI_TTS_BOOKMARK', 'SPSMF_SAPI_PROPERTIES', 'SSFMOpenForRead',
    'DISPID_SVDisplayUI', 'SPEI_HYPOTHESIS',
    'DISPID_SPERetainedSizeBytes', 'IEnumSpObjectTokens',
    'SPEI_WORD_BOUNDARY', 'SAFTDefault', 'DISPID_SRGRecoContext',
    'SP_VISEME_21', 'ISpeechMMSysAudio', 'DISPID_SGRSTType',
    'ISpXMLRecoResult', 'DISPID_SRCEEndStream', 'SASClosed',
    'SVF_Emphasis', 'SVP_15', 'SREStreamStart',
    'DISPID_SRCEEnginePrivate', 'DISPID_SpeechPhraseAlternates',
    'SITooSlow', 'DISPID_SpeechPhraseRules', 'SpeechEngineConfidence',
    'DISPID_SPEAudioSizeTime', 'SpeechAudioFormatGUIDWave',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SGRsCount', 'SpeechWordType',
    'SSFMOpenReadWrite', 'SpPhoneticAlphabetConverter', 'SpShortcut',
    'ISpeechVoice', 'SP_VISEME_6', 'SREStreamEnd',
    'SAFT12kHz8BitStereo', 'DISPID_SLWsItem', 'DISPID_SOTCGetDataKey',
    'SPEI_MIN_TTS', 'SGRSTTWildcard', 'Speech_Max_Word_Length',
    'SPINTERFERENCE_TOOLOUD', 'DISPID_SPIRule', 'DISPID_SRState',
    'SPGS_ENABLED', 'ISpeechPhraseReplacements', 'eWORDTYPE_ADDED',
    'SRATopLevel', 'DISPID_SVSInputWordPosition',
    'DISPID_SRSetPropertyNumber', 'DISPID_SRGIsPronounceable',
    'SpUnCompressedLexicon', 'DISPID_SVVolume', 'SINoSignal',
    'SWTDeleted', 'eLEXTYPE_RESERVED8', 'DISPID_SpeechCustomStream',
    'DISPID_SRCEFalseRecognition', 'DISPID_SRRDiscardResultInfo',
    'SDTRule', 'SDTAudio', 'SAFT22kHz8BitStereo', 'ISpRecognizer2',
    'SpObjectToken', 'SRSEIsSpeaking', 'SPVPRI_ALERT',
    'DISPID_SVPause', 'SAFTCCITT_ALaw_11kHzStereo',
    'SpeechTokenKeyUI', 'SAFTCCITT_ALaw_44kHzStereo', 'SREHypothesis',
    ...
    'ISpLexicon', 'SPFM_OPEN_READWRITE', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SRSSupportedLanguages', 'DISPID_SRProfile',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SDKEnumKeys',
    'DISPID_SRRGetXMLErrorInfo', 'DISPIDSPTSI_ActiveLength',
    'SP_VISEME_5', 'DISPID_SPRs_NewEnum', 'SAFT11kHz16BitMono',
    'SAFT24kHz8BitMono', 'DISPID_SRCEAudioLevel', 'SP_VISEME_10',
    'DISPID_SDKSetStringValue', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SPRText', 'DISPID_SGRSTRule', 'DISPID_SLPPartOfSpeech',
    'DISPID_SVAudioOutput', 'DISPID_SRCRequestedUIType',
    'SGRSTTDictation', 'ISpeechLexicon',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SRRAudio',
    'SpeechTokenContext', 'DISPID_SASCurrentSeekPosition',
    'SPPHRASEELEMENT', 'DISPID_SGRClear',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SPPROPERTYINFO',
    'SAFTADPCM_44kHzMono', 'DISPID_SRGCmdLoadFromFile',
    'DISPID_SpeechLexiconWords', 'DISPID_SPRules_NewEnum',
    'DISPID_SAFGuid', 'ISpRecoContext', 'DISPID_SRRAlternates',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SpPhraseInfoBuilder',
    'DISPID_SVVoice', 'SGDSActive', 'SPAUDIOSTATE', 'SVPAlert',
    'DISPID_SBSFormat', 'SpeechTokenShellFolder', 'SRARoot',
    'DISPID_SRCEventInterests', 'Speech_StreamPos_RealTime',
    'SECLowConfidence', 'SPSTREAMFORMATTYPE',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SPRulesCount',
    'SpeechEmulationCompareFlags', 'DISPID_SPPParent',
    'SpeechMicTraining', 'DISPID_SLWWord', 'SVSFUnusedFlags',
    'DISPID_SRCEPhraseStart', 'SPRECOSTATE', 'DISPID_SLWLangId',
    'SPEI_INTERFERENCE', 'SPDATAKEYLOCATION', 'SPPS_Unknown',
    'DISPID_SDKOpenKey', 'DISPID_SGRsCommitAndSave',
    'DISPID_SPEPronunciation', 'SPBO_NONE', 'DISPID_SGRsDynamic',
    'DISPID_SVEEnginePrivate', 'DISPID_SWFEBlockAlign',
    'DISPID_SVGetAudioInputs', 'SPEVENT', 'SAFTADPCM_11kHzMono',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'ISpRecoGrammar',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SREFalseRecognition',
    'SPAR_Medium', 'SAFTGSM610_44kHzMono', 'SPWORDPRONOUNCEABLE',
    'DISPID_SPEsItem', 'SpeechTokenValueCLSID', 'SPAR_Unknown',
    'ISpeechAudio', 'SP_VISEME_19', 'DISPID_SRGId', 'DISPID_SLPType',
    'SVSFParseSapi', 'SPEI_ADAPTATION', 'SPEI_MIN_SR',
    'DISPID_SLGetPronunciations', 'SpeechTokenKeyFiles',
    'SP_VISEME_15', 'SASStop', 'DISPID_SMSSetData', 'SSTTTextBuffer',
    'SpeechGrammarTagWildcard', 'SP_VISEME_4', 'SPEVENTSOURCEINFO',
    'SpeechDisplayAttributes', 'SpeechGrammarRuleStateTransitionType',
    'DISPID_SPPChildren', 'SDA_No_Trailing_Space', 'SGLexical',
    'SAFTCCITT_ALaw_8kHzStereo', 'ISpeechGrammarRuleStateTransition',
    'ISpShortcut', 'SAFT12kHz16BitStereo', 'SPPS_NotOverriden',
    'DISPID_SpeechBaseStream', 'DISPID_SDKSetLongValue',
    'DISPID_SPPId', 'SpeechRuleAttributes',
    'DISPID_SpeechMemoryStream', 'SAFT24kHz16BitStereo',
    'DISPID_SRGSetWordSequenceData', 'SVSFNLPMask', 'SLOStatic',
    'SpLexicon', 'SpeechAudioVolume', 'DISPID_SDKGetlongValue',
    'SPVPRI_OVER', 'SGSDisabled', 'DISPID_SPACommit',
    'SPPS_RESERVED4', 'SSSPTRelativeToStart', 'SAFT8kHz16BitStereo',
    'SpCustomStream', 'SpeechDataKeyLocation',
    'SPADAPTATIONRELEVANCE', 'SREInterference',
    'eLEXTYPE_LETTERTOSOUND', 'SRCS_Enabled',
    'DISPID_SRGetPropertyNumber', 'SP_VISEME_20',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SRGCmdLoadFromMemory',
    'DISPID_SRAudioInput', 'DISPID_SPPName', '__MIDL_IWinTypes_0009',
    'SVP_5', 'DISPID_SPEDisplayAttributes',
    'DISPID_SpeechPhraseElement', 'SITooQuiet', 'SAFT16kHz8BitStereo',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SOTSetId', 'DISPID_SDKDeleteValue',
    'DISPID_SVEventInterests', 'DISPID_SFSOpen', 'SPFM_OPEN_READONLY',
    'SPWORDPRONUNCIATIONLIST', 'eLEXTYPE_PRIVATE12',
    'ISpeechResourceLoader', 'DISPID_SpeechAudio', 'DISPID_SOTsItem',
    'SAFT44kHz16BitMono', 'SVP_2', 'ISpeechRecoResultDispatch',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SGRsCommit',
    'SDTAlternates', 'DISPID_SABIMinNotification', 'SVSFParseMask',
    'SPRULE', 'ISpMMSysAudio', 'IEnumString', 'SRTStandard',
    'DISPID_SPAStartElementInResult', 'SPEI_TTS_AUDIO_LEVEL',
    'DISPID_SpeechPhraseElements', 'SPEI_MAX_SR',
    'STSF_CommonAppData', 'SpeechRetainedAudioOptions', 'tagSTATSTG',
    'SPCT_SLEEP', 'SAFT32kHz8BitMono', 'SPSInterjection',
    'ISequentialStream', 'SAFTADPCM_11kHzStereo', 'SBONone',
    'SVSFPersistXML', 'SPRST_INACTIVE', 'ISpAudio',
    'SECNormalConfidence', 'SWPKnownWordPronounceable',
    'SAFT8kHz8BitStereo', 'DISPID_SGRAddState',
    'SpeechGrammarTagUnlimitedDictation', 'SPVOICESTATUS',
    'DISPID_SpeechRecognizerStatus', 'SVSFParseSsml',
    'SpeechAddRemoveWord', 'ISpeechLexiconWords',
    'SAFT16kHz16BitStereo', 'SRADynamic', 'SVPNormal',
    'DISPID_SRGetFormat', 'SpeechCategoryAudioIn',
    'DISPID_SWFESamplesPerSec', 'DISPID_SRRPhraseInfo',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'DISPID_SLPsCount',
    'SAFTCCITT_uLaw_11kHzMono', 'SVSFIsNotXML', 'SAFT12kHz8BitMono',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SECFIgnoreWidth',
    'DISPID_SGRSTPropertyId', '_ISpeechVoiceEvents',
    'SPSEMANTICERRORINFO', 'DISPID_SVSLastStreamNumberQueued',
    'ISpResourceManager', 'DISPID_SRGCmdSetRuleState', 'SpFileStream',
    'DISPID_SRCEPropertyStringChange', 'SPFM_CREATE',
    'DISPID_SRRSpeakAudio', 'DISPID_SPPConfidence', 'DISPID_SGRId',
    'SPINTERFERENCE_LATENCY_WARNING', 'IStream', 'eLEXTYPE_RESERVED9',
    'SPSEMANTICFORMAT', 'SPWORDTYPE', 'SAFT22kHz16BitStereo',
    'SAFTADPCM_22kHzStereo', 'SAFTADPCM_8kHzStereo',
    'ISpeechRecoGrammar', 'SAFT44kHz16BitStereo',
    'DISPID_SRCEAdaptation', 'SPEI_RESERVED5', 'DISPID_SVEAudioLevel',
    'SPVISEMES', 'ISpeechPhraseAlternate', 'eLEXTYPE_RESERVED10',
    'SDTLexicalForm', 'tagSPTEXTSELECTIONINFO',
    'SpeechRegistryUserRoot', 'DISPID_SGRSTsCount', 'SPEI_SOUND_END',
    'ISpeechPhraseReplacement', 'DISPID_SASetState',
    'DISPID_SRGDictationUnload', 'STCInprocHandler',
    'SPPS_Noncontent', 'SpeechAudioState', 'SAFT22kHz8BitMono',
    'ISpObjectWithToken', 'SREStateChange', 'SRCS_Disabled',
    'SPSNoun', 'SPEI_REQUEST_UI', 'SP_VISEME_11', 'SPPHRASERULE',
    'SVP_19', 'eLEXTYPE_APP', 'DISPID_SRGState', 'DISPID_SAStatus',
    'SPCS_DISABLED', 'DISPID_SRCCreateGrammar',
    'DISPID_SRCAudioInInterferenceStatus', 'DISPID_SAFType',
    'SPINTERFERENCE', 'SPWORD', 'DISPID_SOTRemoveStorageFileName',
    'SpeechVisemeFeature', 'SpeechVisemeType', 'DISPID_SVEWord',
    'DISPID_SpeechGrammarRuleStateTransition', 'DISPID_SPCLangId',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SpeechLexiconPronunciation',
    'DISPID_SOTIsUISupported', 'DISPID_SGRSTPropertyValue',
    'DISPID_SBSWrite', 'SpeechRecognizerState', 'DISPID_SASState',
    'SPAS_PAUSE', 'SP_VISEME_8', 'DISPID_SpeechLexicon',
    'DISPID_SRCEHypothesis', 'SPWAVEFORMATTYPE',
    ...
    'DISPID_SPIProperties', 'SAFT48kHz16BitStereo',
    'SAFTNoAssignedFormat', 'eLEXTYPE_PRIVATE2',
    'SPEI_START_SR_STREAM', 'SpAudioFormat', 'SPLO_STATIC',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SPRuleId', 'DISPID_SPAsCount',
    'SP_VISEME_18', 'SREPropertyStringChange', 'SPSLMA',
    'SpWaveFormatEx', 'SPCATEGORYTYPE', 'SP_VISEME_17',
    'SDKLDefaultLocation', 'DISPID_SPILanguageId',
    'SpeechVoicePriority', 'DISPID_SPCIdToPhone',
    'DISPID_SRCCmdMaxAlternates', 'SPFM_NUM_MODES',
    'SpeechAudioFormatType', 'SECHighConfidence', 'DISPID_SRGRules',
    'DISPID_SGRSTNextState', 'SVP_11', 'eLEXTYPE_USER_SHORTCUT',
    'SAFT16kHz16BitMono', 'SVP_7', 'DISPID_SRCBookmark',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SMSADeviceId',
    'SPEI_VOICE_CHANGE', 'eLEXTYPE_PRIVATE7', 'SAFTGSM610_8kHzMono',
    'SP_VISEME_1', 'DISPID_SVEViseme', 'SAFTADPCM_8kHzMono',
    'DISPID_SRCSetAdaptationData', 'ISpeechRecognizer',
    'SAFTGSM610_11kHzMono', 'STCLocalServer', 'DISPID_SOTCSetId',
    'SSSPTRelativeToEnd', 'ISpeechLexiconPronunciations',
    'DISPID_SVEStreamEnd', 'DISPID_SpeechRecoResultTimes',
    'SpeechStreamFileMode', 'ISpPhoneConverter', 'DISPID_SOTId',
    'DISPID_SMSALineId', 'SPINTERFERENCE_NONE', 'eLEXTYPE_PRIVATE14',
    'DISPID_SGRsItem', 'SPEVENTENUM',
    'ISpeechTextSelectionInformation',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SGRAddResource',
    'STCInprocServer', 'DISPID_SPIEnginePrivateData',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SPEs_NewEnum',
    'DISPID_SPPEngineConfidence', 'STCAll', 'Speech_Max_Pron_Length',
    'SpeechRecoProfileProperties', 'SpeechTokenIdUserLexicon',
    'ISpeechAudioFormat', 'SAFTADPCM_22kHzMono',
    'ISpeechCustomStream', 'eLEXTYPE_PRIVATE15', 'SDKLCurrentConfig',
    'DISPID_SVSRunningState', 'ISpeechRecoResult2',
    'DISPID_SRCERecognition',
    'DISPID_SpeechGrammarRuleStateTransitions', 'DISPID_SLWType',
    'SPDKL_CurrentUser', 'SpeechAudioProperties', 'SPPS_LMA',
    'SPAR_High', 'DISPID_SPIGetText', 'DISPID_SRRTLength',
    'DISPID_SABIBufferSize', 'DISPID_SpeechVoiceEvent',
    'SpeechInterference', 'STSF_AppData', 'SDTDisplayText',
    'SGRSTTRule', 'SAFT24kHz16BitMono',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SRCPause',
    'DISPID_SGRSAddRuleTransition', 'SRTReSent', 'SVEWordBoundary',
    'SP_VISEME_3', 'SAFTCCITT_ALaw_11kHzMono', 'DISPIDSPTSI',
    'DISPID_SOTGetStorageFileName', 'SPPS_Function',
    'DISPID_SABufferInfo', 'SPINTERFERENCE_TOOQUIET', 'SP_VISEME_13',
    'SPPS_Interjection', 'DISPID_SLPs_NewEnum',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SpeechLexiconProns',
    'DISPID_SLAddPronunciationByPhoneIds', 'SVEPhoneme',
    'SpeechAudioFormatGUIDText', 'SpeechStreamSeekPositionType',
    'SPGS_EXCLUSIVE', 'DISPID_SLWsCount', 'SPBOOKMARKOPTIONS',
    'SVEViseme', 'DISPID_SRCRecognizer', 'DISPID_SVStatus',
    'SECFEmulateResult', 'DISPID_SRGSetTextSelection',
    'SREPropertyNumChange', 'SAFTCCITT_uLaw_22kHzMono',
    'SPGS_DISABLED', 'DISPID_SGRSAddWordTransition', 'SVP_10',
    'SP_VISEME_12', 'SVP_0', 'DISPID_SRRRecoContext',
    'SSSPTRelativeToCurrentPosition', 'SPRS_ACTIVE', 'SVP_12',
    'SSFMCreateForWrite', 'SECFIgnoreCase', 'SREBookmark',
    'SpeechGrammarWordType', 'ISpeechPhraseProperty',
    'SpSharedRecognizer', 'SREAudioLevel', 'ISpGrammarBuilder',
    'ISpEventSource', 'eLEXTYPE_RESERVED4', 'ISpRecoCategory',
    'IInternetSecurityManager', 'SPCONTEXTSTATE', 'SASRun', 'SVP_16',
    'SpeechLoadOption', 'SPRS_INACTIVE', 'SPEI_MAX_TTS',
    'SGPronounciation', 'ISpPhraseAlt', 'SRTEmulated',
    'DISPID_SVResume', 'SPXMLRESULTOPTIONS', 'SLODynamic',
    'SGSExclusive', 'SVSFParseAutodetect', 'SPAUDIOSTATUS',
    'ISpStreamFormat', 'SpVoice', 'ISpeechPhraseInfoBuilder', 'SVP_3',
    'DISPID_SRSAudioStatus', '_SPAUDIOSTATE', 'SPSUnknown',
    'SP_VISEME_14', 'DISPID_SPPValue', 'SVP_20', 'DISPID_SVEBookmark',
    'ISpeechPhraseRules', 'SAFTTrueSpeech_8kHz1BitMono',
    'ISpeechObjectTokens', 'SpPhoneConverter', 'SpeechDiscardType',
    'SpeechRecoEvents', 'SAFT44kHz8BitStereo', 'SPBINARYGRAMMAR',
    'SVP_4', 'DISPID_SWFEExtraData', 'DISPID_SASNonBlockingIO',
    'SPEI_RESERVED3', 'ISpeechWaveFormatEx', 'SAFTNonStandardFormat',
    'DISPID_SRRTStreamTime', 'SAFT12kHz16BitMono',
    'DISPID_SLGenerationId', 'DISPID_SRSCurrentStreamPosition',
    'SDKLLocalMachine', 'SRTExtendableParse',
    'SPRS_ACTIVE_USER_DELIMITED', 'SVSFIsFilename', 'SPAS_CLOSED',
    'ISpObjectToken', 'DISPID_SVSpeak', 'SVSFVoiceMask',
    'DISPID_SGRsAdd', 'DISPID_SRCESoundEnd',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SPAsItem',
    'DISPID_SDKCreateKey', 'SPSHORTCUTPAIRLIST',
    'DISPID_SpeechPhraseAlternate', 'SSTTDictation',
    'Speech_Default_Weight', 'SVEAudioLevel',
    'DISPID_SpeechFileStream', 'SREAdaptation',
    'DISPID_SpeechPhraseBuilder', 'SPWF_INPUT', 'SPEI_END_SR_STREAM',
    'SpTextSelectionInformation', 'DISPID_SPIElements',
    'DISPID_SRRTimes', 'ISpeechRecoResult', 'SpeechVoiceSpeakFlags',
    'SWTAdded', 'DISPID_SpeechPhraseProperties',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SPRuleParent',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SLRemovePronunciation',
    'SpeechPropertyAdaptationOn', 'DISPID_SpeechAudioBufferInfo',
    'SPWF_SRENGINE', 'SRERecoOtherContext', 'SRSEDone',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SGRs_NewEnum',
    'SGDSInactive', 'DISPID_SVSCurrentStreamNumber',
    'SAFTCCITT_ALaw_8kHzMono', '_ISpeechRecoContextEvents',
    'SGSEnabled', 'DISPID_SWFEChannels',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SRGetPropertyString',
    'SPCT_DICTATION', 'SpeechRecoContextState', 'SECFNoSpecialChars',
    'SPRECOCONTEXTSTATUS', 'WAVEFORMATEX', 'DISPID_SOTGetDescription',
    'SPEI_RESERVED2', 'DISPID_SOTs_NewEnum', 'eLEXTYPE_PRIVATE5',
    'SAFT32kHz16BitMono', 'DISPID_SRGDictationSetState',
    'DISPID_SGRSTsItem', 'SDKLCurrentUser', 'SPSVerb',
    'SRAORetainAudio', 'DISPID_SVGetAudioOutputs',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'STSF_LocalAppData',
    'DISPID_SABufferNotifySize', 'SRERecognition',
    'DISPID_SpeechRecoContext', 'DISPIDSPTSI_SelectionLength',
    'SPCS_ENABLED', 'DISPID_SDKGetStringValue', 'SpeechUserTraining',
    'DISPID_SOTCId', 'SGRSTTWord', 'DISPID_SpeechDataKey',
    'DISPID_SPRuleConfidence', 'SpeechFormatType',
    'DISPID_SPIEngineId', 'SPFM_CREATE_ALWAYS',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SOTDataKey',
    'SGLexicalNoSpecialChars', 'ISpRecognizer3', 'SVEAllEvents',
    ...
    'SVSFPurgeBeforeSpeak', 'SpMemoryStream',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SPPsItem',
    'SPCT_COMMAND', 'DISPID_SASFreeBufferSpace', 'DISPID_SOTsCount',
    'DISPID_SPAs_NewEnum', 'SAFT32kHz16BitStereo',
    'eLEXTYPE_RESERVED6', 'ISpProperties', 'DISPID_SpeechRecoResult2',
    'DISPID_SVSInputWordLength', 'SPSNotOverriden', 'SP_VISEME_7',
    'SpeechCategoryRecognizers', 'eLEXTYPE_PRIVATE9', 'SVP_18',
    'SSTTWildcard', 'SPEI_SR_BOOKMARK', 'DISPID_SVEStreamStart',
    'SINone', 'SPWT_LEXICAL', 'SPEI_SR_PRIVATE', 'eLEXTYPE_RESERVED7',
    'DISPID_SRGCmdLoadFromResource', 'DISPIDSPRG', 'SLTUser',
    'eLEXTYPE_USER', 'DISPID_SWFEBitsPerSample', 'SRESoundStart',
    'SPRECOGNIZERSTATUS', 'SBOPause', 'SPSHT_NotOverriden',
    'SVSFIsXML', 'DISPID_SPRuleName', 'ISpDataKey',
    'SPEI_TTS_PRIVATE', 'SPSFunction', 'SpeechTokenKeyAttributes',
    'DISPID_SDKDeleteKey', 'SPEI_START_INPUT_STREAM',
    'SAFT11kHz16BitStereo', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SVSVisemeId', 'DISPID_SRGDictationLoad',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SLWs_NewEnum',
    'DISPID_SpeechRecoResult', 'DISPID_SOTCategory',
    'DISPID_SpeechGrammarRules', 'ISpeechPhraseRule',
    'DISPID_SMSAMMHandle', 'SPEI_PHRASE_START',
    'DISPID_SpeechPhraseProperty', 'SpeechPropertyResourceUsage',
    'SPEI_VISEME', 'DISPID_SRGCmdSetRuleIdState',
    'ISpeechGrammarRule', 'DISPID_SpeechObjectToken',
    'DISPID_SPRuleNumberOfElements', 'SGDSActiveWithAutoPause',
    'DISPID_SpeechPhraseInfo', 'SPEI_RECOGNITION',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SpeechAllElements', 'SVP_8',
    'DISPID_SASCurrentDevicePosition', 'ISpeechLexiconWord',
    'DISPID_SWFEFormatTag', 'ISpeechPhraseProperties', 'ISpStream',
    'SPSHT_EMAIL', 'ISpeechLexiconPronunciation', 'DISPID_SBSSeek',
    'SVEEndInputStream', 'DISPID_SWFEAvgBytesPerSec',
    'DISPID_SGRSTText', 'DISPID_SpeechRecognizer',
    'DISPID_SRCEStartStream', 'DISPID_SpeechRecoContextEvents',
    'DISPID_SOTRemove', 'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SRRSetTextFeedback', 'DISPID_SRCERequestUI',
    'DISPID_SGRSTWeight', 'DISPID_SVSLastBookmark',
    'DISPID_SGRInitialState', 'SVP_17', 'SpeechPartOfSpeech',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SVWaitUntilDone',
    'ISpeechFileStream', 'SDTReplacement', 'DISPID_SGRName',
    'SPEI_SR_RETAINEDAUDIO', 'ISpeechRecognizerStatus', 'SPSModifier',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SPEActualConfidence',
    'SVF_Stressed', 'ISpeechBaseStream', 'DISPID_SPEAudioSizeBytes',
    'SVP_14', 'SpInprocRecognizer', 'ISpeechRecoContext', 'SVP_9',
    'SVEVoiceChange', 'SWPUnknownWordPronounceable',
    'ISpeechPhraseAlternates', 'DISPID_SLWPronunciations',
    'SPSHORTCUTPAIR', 'SECFDefault', 'DISPID_SpeechPhoneConverter',
    'ISpNotifyTranslator', 'SFTInput', 'SVSFDefault', 'SITooLoud',
    'DISPID_SPIReplacements', 'SAFT24kHz8BitStereo', 'ISpeechDataKey',
    'SpeechCategoryRecoProfiles', 'eLEXTYPE_PRIVATE1',
    'eLEXTYPE_PRIVATE20', 'SRSInactive', 'DISPID_SRRecognizer',
    ...
    'DISPID_SBSRead', 'SPLEXICONTYPE', 'SVEBookmark',
    'DISPID_SADefaultFormat', 'SPEI_SENTENCE_BOUNDARY',
    'SAFTCCITT_uLaw_11kHzStereo', 'SRAInterpreter',
    'DISPID_SVGetProfiles', 'SPRST_ACTIVE', 'DISPID_SRCVoice',
    'SpeechVoiceCategoryTTSRate', 'SFTSREngine',
    'DISPID_SVSLastBookmarkId', 'SPWT_PRONUNCIATION',
    'DISPID_SpeechGrammarRule', 'SECFIgnoreKanaType',
    'ISpeechObjectToken', 'SSFMCreate', 'SPPS_Modifier',
    'DISPID_SpeechPhraseRule',
    'DISPID_SRCERecognitionForOtherContext', 'DISPID_SGRAttributes',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'ISpeechGrammarRuleState', 'SPRECORESULTTIMES',
    'DISPID_SpeechAudioStatus', 'SpeechDictationTopicSpelling',
    'ISpStreamFormatConverter', 'DISPID_SPPs_NewEnum',
    'DISPID_SRIsShared', 'DISPID_SPPsCount', 'SPPARTOFSPEECH',
    'DISPID_SPIGrammarId', 'SVEStartInputStream', 'SPRULESTATE',
    'eLEXTYPE_PRIVATE17', 'SPPS_SuppressWord',
    'DISPID_SPPBRestorePhraseFromMemory', 'SAFT11kHz8BitStereo',
    'SPEI_SOUND_START', 'SGDSActiveUserDelimited',
    'SAFT11kHz8BitMono', 'SpResourceManager', 'DISPID_SPIStartTime',
    'SPRST_NUM_STATES', 'SpNullPhoneConverter', 'SPBO_AHEAD',
    'SAFT8kHz8BitMono', 'SPPHRASEREPLACEMENT',
    'DISPID_SREmulateRecognition', 'DISPID_SPRsItem',
    'DISPID_SVIsUISupported', 'DISPID_SGRsFindRule',
    'SPXRO_Alternates_SML', 'SpMMAudioEnum',
    'DISPID_SAFSetWaveFormatEx', 'SGDisplay', 'SpeechRunState',
